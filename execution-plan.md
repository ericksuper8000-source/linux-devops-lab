...
- **Current lab / task:** Lab 03 ✅ Complete. Next: Lab 04 — Files, Inodes & Links (`docs/labs/lab-04...` — pending creation)
- **Phase 1 (VM Setup):** ✅ Complete
- **Phase 2 (Meeting Debian):** ✅ Complete
- **Phase 3 (Version Control):** ✅ Complete (Labs 01–02)
- **Last completed item:** Lab 03 — Filesystem & FHS: explored `/etc`, `/var`, `/usr`, `/home`, `/tmp`, `/opt`; understood FHS contract; absolute vs relative paths; symlinks (`bin -> usr/bin`); `ls -la` detailed output
- **Daily recap status:** N/A — protocol not applied today (starts from 2026-09-08 onward)
- **Next session target:** Lab 04 — Files, Inodes & Links (concept-first: what a file is; inodes and metadata; hard links vs soft links; `ls -li`, `ln`, `stat`, `file`)
